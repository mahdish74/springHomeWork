...
public class PrintRequestControllerUpdateTest {
    ...
    public void when_give_EmptyPersonalCode_then_getRelatedMessageAboutPersonalCode() {
        ...
        String actual = restTemplate.exchange("http://localhost:" + port + "/api/PrintRequest/update/" + printRequestCode, HttpMethod.PUT, request, String.class).getBody();
